#*********************************************************
#  synthesize script for cell: rammux                     *
#*********************************************************
...
define_design_lib MY_LIB -path /tmp/erdehaan/GitHub/DaC/hardware/opdracht3/ram3/syn_work
define_design_lib CELLSLIB -path /data/public/common/software/opprog/synth_libs/CellsLib
read_file -format vhdl -work MY_LIB /tmp/erdehaan/GitHub/DaC/hardware/opdracht3/ram3/VHDL/ram_pkg.vhd
read_file -format vhdl -work MY_LIB {/tmp/erdehaan/GitHub/DaC/hardware/opdracht3/ram3/VHDL/rammux.vhd /tmp/erdehaan/GitHub/DaC/hardware/opdracht3/ram3/VHDL/rammux-behaviour.vhd}
...
report_area
report_fsm
write_file -f ddc rammux -output /tmp/erdehaan/GitHub/DaC/hardware/opdracht3/ram3/ADB/rammux.ddc
write_file -f vhdl rammux -output /tmp/erdehaan/GitHub/DaC/hardware/opdracht3/ram3/VHDL/rammux_SYNTH.vhd
quit

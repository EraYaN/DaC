...
define_design_lib MY_LIB -path /tmp/jkerkhof/GitHub/DaC/hardware/opdracht3/alu2/syn_work
define_design_lib CELLSLIB -path /data/public/common/software/opprog/synth_libs/CellsLib
read_file -format vhdl -work MY_LIB /tmp/jkerkhof/GitHub/DaC/hardware/opdracht3/alu2/VHDL/Bitsize_pkg.vhd
read_file -format vhdl -work MY_LIB {/tmp/jkerkhof/GitHub/DaC/hardware/opdracht3/alu2/VHDL/alu.vhd /tmp/jkerkhof/GitHub/DaC/hardware/opdracht3/alu2/VHDL/alu-behaviour.vhd}
...
report_area
report_fsm
write_file -f ddc alu -output /tmp/jkerkhof/GitHub/DaC/hardware/opdracht3/alu2/ADB/alu.ddc
write_file -f vhdl alu -output /tmp/jkerkhof/GitHub/DaC/hardware/opdracht3/alu2/VHDL/alu_SYNTH.vhd
quit

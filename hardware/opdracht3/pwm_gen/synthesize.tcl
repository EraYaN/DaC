...
define_design_lib MY_LIB -path /tmp/rphes/DaC/hardware/opdracht3/pwm_gen/syn_work
define_design_lib CELLSLIB -path /data/public/common/software/opprog/synth_libs/CellsLib
read_file -format vhdl -work MY_LIB /tmp/rphes/DaC/hardware/opdracht3/pwm_gen/VHDL/parameter_def_pkg.vhd
read_file -format vhdl -work MY_LIB {/tmp/rphes/DaC/hardware/opdracht3/pwm_gen/VHDL/pwm_gen.vhd /tmp/rphes/DaC/hardware/opdracht3/pwm_gen/VHDL/pwm_gen-behaviour.vhd}
...
report_area
report_fsm
write_file -f ddc pwm_gen -output /tmp/rphes/DaC/hardware/opdracht3/pwm_gen/ADB/pwm_gen.ddc
write_file -f vhdl pwm_gen -output /tmp/rphes/DaC/hardware/opdracht3/pwm_gen/VHDL/pwm_gen_SYNTH.vhd
quit

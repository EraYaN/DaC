...
\begin{figure}[H]
\centering
		\includegraphics[width=1\textwidth]{images/circuitvgafinal.png}
		
		\caption{Het resultaat van de synthese van de VGA-Controller}
		\label{vgafig:circuit}
\end{figure}
...
De gesynthetiseerde code is gesimuleerd in SLS. De resultaten hiervan zijn te vinden in \ref{vgafig:switch}. 

\begin{figure}[H]
\centering
		\includegraphics[width=1\textwidth]{images/simslsvga-final.png}

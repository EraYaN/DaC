...
\textsc{\Large EPO-3 Moduleopdracht 4}\\[0.5cm] % Major heading such as course name
\textsc{\large Onderdeel: Capaciteiten}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.3 cm]
{ \huge \bfseries Gateoxide-dikte NMOS en PMOS}\\[0.2cm] % Title of your document
\HRule \\[1.4cm]
